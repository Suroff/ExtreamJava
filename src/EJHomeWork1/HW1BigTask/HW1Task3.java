 ...
 * текущую коробку с той, которую подадут в compare в качестве параметра, true – если она равны по весу,
...
public class HW1Task3 {
    ...
    public static void main(String[] args) {
        ...
        Box<Orange> twoboxOrange = new Box<>();
        ...
        System.out.println("Коробка с яблоками в сравнении коробки с апельсинами " +boxApple.compBox(boxOrange));
        boxOrange.putFruitToABox(twoboxOrange);
        System.out.println(boxOrange.getBoxWeight());
        System.out.println(twoboxOrange.getBoxWeight());
